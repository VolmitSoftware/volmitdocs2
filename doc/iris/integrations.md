...
<div class="iris-grid">
  <div class="iris-card">
    ...
    <div class="button-group">
      ...
      <a class="iris-button" href="/doc/iris/integrations/mythicmobs" target="_blank" rel="noopener">Docs</a>
    </div>
  </div>
  ...
  <div class="iris-card">
    ...
    <h3>ItemsAdder</h3>
    <p>Custom Items in Iris world. See their documentation.</p>
    <div class="button-group">
      ...
      <a class="iris-button" href="https://itemsadder.devs.beer/compatibility-with-other-plugins/compatible/iris" target="_blank" rel="noopener">Docs</a>
    </div>
  </div>
  ...
  <div class="iris-card">
    ...
    <h3>Nexo</h3>
    <p>Add Nexo custom blocks to your Minecraft world.</p>
    <div class="button-group">
      <a class="iris-button" href="https://polymart.org/product/6901/nexo" target="_blank" rel="noopener">Visit Plugin</a>
      <a class="iris-button" href="/doc/iris/integrations/nexo" target="_blank" rel="noopener">Docs</a>
    </div>
  </div>
